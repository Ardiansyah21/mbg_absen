...
<div class="container mx-auto p-4">
    ...
    @php
    $urutanTugas = [
    'Asisten Lapangan','Persiapan', 'Pengolahan', 'Pemorsian', 'Distribusi',
    'Kebersihan', 'Pencucian', 'Koordinator'
    ];
    ...
    return $posA <=> $posB;
        ...
        <tr class="hover:bg-sky-50 transition">
            ...
            <td class="px-3 py-2">{{ $absensi['tugas'] ?? '-' }}</td>
            ...
            <td class="px-3 py-2 text-center sticky right-0 bg-white">
                <div class="flex flex-col gap-2 items-center">
                    ...
                    <a href="javascript:void(0)" onclick="openDuplikatModal({{ $absensi['id'] }})"
                        class="px-3 py-1 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 text-xs shadow w-24 text-center">Duplikat</a>
        ...
        <div id="modalDuplikat"
            class="fixed inset-0 bg-black bg-opacity-40 hidden flex items-center justify-center z-50">
            <div
                class="bg-white rounded-xl shadow-xl shadow-yellow-500 w-full max-w-md p-6 border-t-4 border-yellow-500">
                <div class="flex justify-between items-center mb-4">
